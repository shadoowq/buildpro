        ...
        <div className="flex-1 flex items-center justify-center px-8 py-8 overflow-y-auto">
          <div className="w-full max-w-sm">
                ...
                <button key={item.type}
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border text-xs font-bold transition-all ${
                    formData.userType === item.type
                      ...
                      : 'border-[#E2EAF2] text-slate-500 hover:bg-[#F0F4F8]'
                  }`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input type="text" name="name" value={formData.name} onChange={handleChange}
                    ...
                    className="w-full border border-[#E2EAF2] bg-[#F8FAFC] rounded-xl px-3 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1B9AAA] focus:border-transparent transition-all" />
                </div>
                <div>
                  <label className="block text-xs font-semibold text-slate-700 mb-1.5">
              ...
              <div>
                ...
                <input type="tel" name="phone" value={formData.phone} onChange={handleChange}
                  ...
                  className="w-full border border-[#E2EAF2] bg-[#F8FAFC] rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#1B9AAA] focus:border-transparent transition-all"
                  dir="ltr" />
              </div>
              ...
              {/* submit */}
              <button type="submit"
                className="w-full bg-[#0F4C75] hover:bg-[#0D3F63] text-white font-bold py-3 rounded-xl text-sm transition-colors mt-1">
            ...
            <div className="text-center mt-4 space-y-2">
              ...
              <p>
                <Link href="/" className="text-slate-400 hover:text-[#0F4C75] text-xs transition-colors">
