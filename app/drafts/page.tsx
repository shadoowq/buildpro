...
export default function Drafts() {
  ...
  const formatDate = (ts: string) =>
    new Date(ts).toLocaleDateString(lang === 'ar' ? 'ar-EG-u-nu-latn' : 'en-US', { year: 'numeric', month: 'short', day: 'numeric' });

  const formatTime = (ts: string) =>
    new Date(ts).toLocaleTimeString(lang === 'ar' ? 'ar-EG-u-nu-latn' : 'en-US', { hour: '2-digit', minute: '2-digit' });
